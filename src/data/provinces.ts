...
export const PROVINCES: Province[] = [
  ...
  },
  {
    ...
    highlights: ['Đèo Ô Quy Hồ', 'Suối nước nóng Vàng Pheo', 'Putaleng', 'Bản Sin Suối Hồ'],
    places: [
  ...
  },
  {
    ...
    foods: ['Bánh cuốn Cao Bằng', 'Phở chua', 'Cháo ấu tẩu', 'Lạp xưởng hun khói'],
  ...
  // ===== TÂY NAM BỘ =====
  {
    ...
    highlights: ['Vườn quốc gia Tràm Chim', 'Làng hoa Sa Đéc', 'Khu di tích Xẻo Quýt', 'Đồng sen Tháp Mười'],
    places: [
